...
class Database:
    ...
    async def _seed_worldcup_matches(self, session: AsyncSession) -> None:
        ...
        raw: list[tuple[date, time, str, str, str, str, str, str]] = [
            ...
            (date(2026, 6, 11), time(22, 0), "A", "Corea del Sur", "República Checa", "🇰🇷", "🇨🇿", "Estadio Guadalajara"),
            (date(2026, 6, 18), time(16, 0), "A", "República Checa", "Sudáfrica", "🇨🇿", "🇿🇦", "Atlanta Stadium"),
            (date(2026, 6, 18), time(23, 0), "A", "México", "Corea del Sur", "🇲🇽", "🇰🇷", "Estadio Guadalajara"),
            (date(2026, 6, 24), time(23, 0), "A", "República Checa", "México", "🇨🇿", "🇲🇽", "Mexico City Stadium"),
            (date(2026, 6, 24), time(23, 0), "A", "Sudáfrica", "Corea del Sur", "🇿🇦", "🇰🇷", "Estadio Monterrey"),
            # Group B
            ...
            (date(2026, 6, 13), time(23, 0), "C", "Haití", "Escocia", "🇭🇹", "🏴󠁧󠁢󠁳󠁣󠁴󠁿", "Boston Stadium"),
            (date(2026, 6, 19), time(22, 0), "C", "Escocia", "Marruecos", "🏴󠁧󠁢󠁳󠁣󠁴󠁿", "🇲🇦", "Boston Stadium"),
            (date(2026, 6, 20), time(0, 30), "C", "Brasil", "Haití", "🇧🇷", "🇭🇹", "Philadelphia Stadium"),
            (date(2026, 6, 24), time(22, 0), "C", "Escocia", "Brasil", "🏴󠁧󠁢󠁳󠁣󠁴󠁿", "🇧🇷", "Miami Stadium"),
            (date(2026, 6, 24), time(22, 0), "C", "Marruecos", "Haití", "🇲🇦", "🇭🇹", "Atlanta Stadium"),
            # Group D
            (date(2026, 6, 12), time(23, 0), "D", "Estados Unidos", "Paraguay", "🇺🇸", "🇵🇾", "Los Angeles Stadium"),
            (date(2026, 6, 14), time(2, 0), "D", "Australia", "Turquía", "🇦🇺", "🇹🇷", "BC Place Vancouver"),
            (date(2026, 6, 19), time(19, 0), "D", "Estados Unidos", "Australia", "🇺🇸", "🇦🇺", "Seattle Stadium"),
            (date(2026, 6, 20), time(1, 0), "D", "Turquía", "Paraguay", "🇹🇷", "🇵🇾", "San Francisco Bay Area Stadium"),
            (date(2026, 6, 26), time(1, 0), "D", "Turquía", "Estados Unidos", "🇹🇷", "🇺🇸", "Los Angeles Stadium"),
            (date(2026, 6, 26), time(1, 0), "D", "Paraguay", "Australia", "🇵🇾", "🇦🇺", "San Francisco Bay Area Stadium"),
            # Group E
            ...
            (date(2026, 6, 21), time(1, 0), "E", "Ecuador", "Curazao", "🇪🇨", "🇨🇼", "Kansas City Stadium"),
            ...
            (date(2026, 6, 15), time(0, 0), "F", "Suecia", "Túnez", "🇸🇪", "🇹🇳", "Estadio Monterrey"),
            (date(2026, 6, 20), time(17, 0), "F", "Países Bajos", "Suecia", "🇳🇱", "🇸🇪", "Houston Stadium"),
            (date(2026, 6, 21), time(2, 0), "F", "Túnez", "Japón", "🇹🇳", "🇯🇵", "Estadio Monterrey"),
            ...
            (date(2026, 6, 15), time(23, 0), "G", "Irán", "Nueva Zelanda", "🇮🇷", "🇳🇿", "Los Angeles Stadium"),
            ...
            (date(2026, 6, 26), time(2, 0), "G", "Egipto", "Irán", "🇪🇬", "🇮🇷", "Seattle Stadium"),
            (date(2026, 6, 26), time(2, 0), "G", "Nueva Zelanda", "Bélgica", "🇳🇿", "🇧🇪", "BC Place Vancouver"),
            # Group H
            ...
            (date(2026, 6, 26), time(0, 0), "H", "Cabo Verde", "Arabia Saudita", "🇨🇻", "🇸🇦", "Houston Stadium"),
            (date(2026, 6, 26), time(0, 0), "H", "Uruguay", "España", "🇺🇾", "🇪🇸", "Estadio Guadalajara"),
            # Group I
            ...
            # Group J
            (date(2026, 6, 16), time(23, 0), "J", "Argentina", "Argelia", "🇦🇷", "🇩🇿", "Kansas City Stadium"),
            (date(2026, 6, 17), time(2, 0), "J", "Austria", "Jordania", "🇦🇹", "🇯🇴", "San Francisco Bay Area Stadium"),
            (date(2026, 6, 22), time(17, 0), "J", "Argentina", "Austria", "🇦🇷", "🇦🇹", "Dallas Stadium"),
            (date(2026, 6, 23), time(1, 0), "J", "Jordania", "Argelia", "🇯🇴", "🇩🇿", "San Francisco Bay Area Stadium"),
            (date(2026, 6, 27), time(2, 0), "J", "Argelia", "Austria", "🇩🇿", "🇦🇹", "Kansas City Stadium"),
            (date(2026, 6, 27), time(2, 0), "J", "Jordania", "Argentina", "🇯🇴", "🇦🇷", "Dallas Stadium"),
            # Group K
            (date(2026, 6, 17), time(17, 0), "K", "Portugal", "RD Congo", "🇵🇹", "🇨🇩", "Houston Stadium"),
            (date(2026, 6, 18), time(0, 0), "K", "Uzbekistán", "Colombia", "🇺🇿", "🇨🇴", "Mexico City Stadium"),
            (date(2026, 6, 23), time(17, 0), "K", "Portugal", "Uzbekistán", "🇵🇹", "🇺🇿", "Houston Stadium"),
            (date(2026, 6, 24), time(0, 0), "K", "Colombia", "RD Congo", "🇨🇴", "🇨🇩", "Estadio Guadalajara"),
